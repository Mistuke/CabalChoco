...
$url64       = 'https://downloads.haskell.org/cabal/cabal-install-3.12.1.0/cabal-install-3.12.1.0-x86_64-windows.zip'
...
Install-ChocolateyZipPackage `
  ...
  -Url64bit $url64 -ChecksumType64 sha256 -Checksum64 96854db86ba3ac90dd1a94ec2960311b3885da6d91ed7641f06d84c8e2eebdec
