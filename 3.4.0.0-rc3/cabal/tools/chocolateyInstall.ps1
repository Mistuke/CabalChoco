...
$url64       = 'https://mistuke.blob.core.windows.net/binaries/unofficial/cabal/cabal-install-3.4.0.0-rc3-x86_64-unknown-mingw32.zip'
...
Install-ChocolateyZipPackage `
  ...
  -Url64bit $url64 -ChecksumType64 sha256 -Checksum64 ce0d02a519732b5b5ecad0fb90e75ca20a6e78d2f152a0d2a95e22da5db9143f
