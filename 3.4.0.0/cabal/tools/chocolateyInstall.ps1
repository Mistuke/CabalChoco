...
$url64       = 'https://downloads.haskell.org/cabal/cabal-install-3.4.0.0/cabal-install-3.4.0.0-x86_64-windows.zip'
...
Install-ChocolateyZipPackage `
  ...
  -Url64bit $url64 -ChecksumType64 sha256 -Checksum64 860fff2d39a82d1dc0ca924a77164d0988af49c2c5f45e15d615144122beb647
