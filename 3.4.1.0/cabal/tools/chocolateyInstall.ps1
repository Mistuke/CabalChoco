...
$url64       = 'https://downloads.haskell.org/cabal/cabal-install-3.4.1.0/cabal-install-3.4.1.0-x86_64-windows.zip'
...
Install-ChocolateyZipPackage `
  ...
  -Url64bit $url64 -ChecksumType64 sha256 -Checksum64 b86761a55a0899e33b6e9b64c75a52b33716430de93ea47bfd07d8f11417e800
