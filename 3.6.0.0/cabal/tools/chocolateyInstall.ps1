...
$url64       = 'https://downloads.haskell.org/cabal/cabal-install-3.6.0.0/cabal-install-3.6.0.0-x86_64-windows.zip'
...
Install-ChocolateyZipPackage `
  ...
  -Url64bit $url64 -ChecksumType64 sha256 -Checksum64 8222b49b6eac3d06aaa390bc688f467e8f949a38943567f46246f8320fd72ded
