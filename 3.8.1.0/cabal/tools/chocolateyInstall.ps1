...
$url64       = 'https://downloads.haskell.org/cabal/cabal-install-3.8.1.0/cabal-install-3.8.1.0-x86_64-windows.zip'
...
Install-ChocolateyZipPackage `
  ...
  -Url64bit $url64 -ChecksumType64 sha256 -Checksum64 b6dd6afe0e5a883f84dc52d836af0e90d9cd2b2978dd87200332085ecb4a0315
